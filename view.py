...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        row1 = ft.Row([ft.Container(self._ddRuolo, width=250),
        ...
        self._txtIdArtista = ft.TextField(label="Id Artista", color="orange", border_color="orange")
        self._btnCercaPercorso = ft.ElevatedButton(text="Cerca Percorso", on_click=self._controller.handleCercaPercorso,
                                                   bgcolor="orange", color="white", disabled=True)

        row3 = ft.Row([ft.Container(self._txtIdArtista, width=250),
